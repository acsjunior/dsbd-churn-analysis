...
\titulocabecalho{Classificação de Churn Utilizando um Modelo de Regressão Logística Binária}
...
\titulo{Classificação de Churn Utilizando um Modelo de Regressão Logística Binária}

\subtitulo{Customer Churn Classification Using a Binary Logistic Regression Model}
...
\begin{primeirapagina}
  ...
  \begin{abstract}
    ...
    \palavraschave{Churn, Retenção de clientes, CRM, Regressão logística binária, Stepwise.}
