...
\titulocabecalho{Classificação de Churn Através da Regressão Logística Binária}
...
\titulo{Classificação de Churn Através da Regressão Logística Binária}

\subtitulo{Customer Churn Classification Through Binary Logistic Regression}
